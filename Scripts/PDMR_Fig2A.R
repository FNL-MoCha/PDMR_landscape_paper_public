...
mat <- read.csv("oncoplot_data_pdx.csv", check.names = F, stringsAsFactors = F)
...
clinical_input <- read.csv("./Supp_tables_pdx_metadata.csv", check.names = F, stringsAsFactors = F)
